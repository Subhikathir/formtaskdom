...
function createMultiSelect() {
    ...
    var opt2 = new Option('parotta', 'parotta');
...
function createState() {
    ...
    var opt5 = new Option('andhra Pradesh', 'andhra Pradesh');
    var opt6 = new Option('maharastra', 'maharastra');
...
function createCountry() {
    ...
    opt1.selected = true;
    var opt2 = new Option('srilanka', 'srilanka');
    var opt3 = new Option('china', 'china');
    var opt4 = new Option('bangladesh', 'bangladesh');
    var opt5 = new Option('pakisthan', 'pakisthan');
    var opt6 = new Option('france', 'france');
    var opt7 = new Option('sauthi arabia', 'sauthi arabia');
